...
export const reportingAutomatizado: ServicePage = {
  ...
  faqs: [
    { q: "¿Con qué herramienta construís los dashboards?", a: "Depende de tus necesidades. Looker Studio (gratuito) es ideal para la mayoría de casos. Power BI para empresas con más complejidad. Notion para equipos que ya trabajan ahí. También construimos dashboards custom con n8n + Google Sheets para casos específicos." },
    { q: "¿Puedo ver el dashboard desde el móvil?", a: "Sí. Looker Studio y Power BI tienen apps móviles. Además, los informes automáticos que se envían por email o Slack son perfectamente legibles en el móvil." },
    { q: "¿Cuántas fuentes de datos podéis conectar?", a: "No hay límite práctico. Las más comunes: Google Analytics, Google Ads, Meta Ads, TikTok Ads, HubSpot, Pipedrive, Mailchimp, ActiveCampaign, Stripe, Shopify, WooCommerce, Google Sheets, Airtable. Si tiene API, lo podemos conectar." },
    { q: "¿Necesito un analista para interpretar el dashboard?", a: "No. Diseñamos los dashboards para que cualquier persona de tu equipo pueda entenderlos. Números grandes, colores claros, comparativas contextualizadas. Si un KPI está en rojo, algo va mal. Si está en verde, todo bien. Sin curva de aprendizaje." },
    { q: "¿Qué pasa si cambio de herramienta o añado una nueva fuente?", a: "La conectamos. Añadir una nueva fuente de datos al dashboard existente es rápido — normalmente 1-2 días de trabajo. El dashboard crece contigo." },
  ],
