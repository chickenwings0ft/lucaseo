...
export const leadScoring: ServicePage = {
  ...
  faqs: [
    { q: "¿Necesito un CRM para implementar lead scoring?", a: "Es muy recomendable. Si usas HubSpot, Pipedrive, Salesforce o similar, implementamos el scoring directamente ahí. Si no tienes CRM, te ayudamos a elegir e implementar uno como parte del proyecto — sin un CRM, los datos de scoring no tienen dónde vivir." },
    { q: "¿Cuántos leads necesito para que el scoring funcione?", a: "El scoring empieza a aportar valor desde 50-100 leads activos. Con menos volumen, es difícil establecer patrones fiables. Pero implementamos el sistema desde el principio para que esté listo cuando escales." },
    { q: "¿El scoring sustituye al criterio de mi equipo comercial?", a: "No, lo complementa. El scoring les dice dónde mirar primero, pero la decisión de cómo abordar a cada lead sigue siendo de tu equipo. Piensa en el scoring como un GPS: te dice por dónde ir, pero tú conduces." },
    { q: "¿Puedo ver por qué un lead tiene una puntuación determinada?", a: "Sí. Cada lead tiene un desglose de su puntuación: qué acciones sumaron puntos, cuáles restaron, y cuándo ocurrieron. Total transparencia para que tu equipo confíe en el sistema." },
    { q: "¿Cuánto tiempo tarda en ser fiable el modelo de scoring?", a: "El modelo base funciona desde el día 1 con criterios de sentido común (visitar precios = alta intención). Pero los datos de cierre tardan en acumularse: entre 1 y 3 meses tienes un modelo calibrado con datos reales de tu negocio." },
  ],
