...
export const automatizaciones: ServicePage = {
  ...
  faqs: [
    { q: "¿Necesito conocimientos técnicos para usar las automatizaciones?", a: "No. Diseñamos los flujos para que funcionen solos. Tu equipo interactúa con sus herramientas habituales — email, CRM, WhatsApp — y la automatización trabaja en segundo plano. Si algún flujo necesita intervención humana, envía una notificación clara con instrucciones." },
    { q: "¿Qué herramientas podéis conectar?", a: "Prácticamente cualquiera que tenga una API o integración: Google Workspace, Microsoft 365, Slack, HubSpot, Salesforce, Notion, Airtable, WhatsApp Business, Shopify, WooCommerce, Holded, Factorial, y cientos más. Si tu herramienta no está en la lista, lo investigamos sin compromiso." },
    { q: "¿Cuánto cuesta automatizar un proceso?", a: "Depende de la complejidad. Un flujo sencillo (ej: clasificar emails entrantes y responder automáticamente) puede estar listo en 3-5 días. Un sistema completo de automatización de reporting con múltiples fuentes de datos puede tardar 2-3 semanas. Siempre presupuestamos antes de empezar, sin sorpresas." },
    { q: "¿Y si algo falla?", a: "Cada automatización incluye gestión de errores. Si un flujo no puede completarse — un email no se envía, una API no responde — el sistema lo detecta, lo registra y te notifica. Además, durante los 3 primeros meses, nuestro equipo monitoriza activamente los flujos y resuelve cualquier incidencia." },
    { q: "¿Las automatizaciones con IA son fiables?", a: "Las que diseñamos sí, porque no les pedimos que hagan cosas para las que no están preparadas. Usamos IA para tareas donde la precisión está demostrada: clasificación, extracción de datos, generación de texto con plantillas, análisis de sentimiento. Para decisiones críticas, el flujo siempre pasa por validación humana." },
  ],
