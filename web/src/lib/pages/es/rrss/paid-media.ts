...
export const paidMedia: ServicePage = {
  ...
  faqs: [
    { q: "¿Cuánto presupuesto necesito para empezar?", a: "Recomendamos un mínimo de 500-1.000€/mes en inversión publicitaria para poder testear, optimizar y obtener datos significativos. Con menos, el algoritmo no tiene suficiente volumen para aprender y los resultados son poco fiables. Nuestro fee de gestión es independiente del presupuesto." },
    { q: "¿En cuánto tiempo veré resultados?", a: "Las primeras conversiones suelen llegar en la primera semana. El período de aprendizaje del algoritmo es de 7-14 días, durante los cuales los costes pueden ser más altos. A partir de la tercera semana, las campañas empiezan a estabilizarse y a mejorar progresivamente. El ROAS óptimo suele alcanzarse entre el mes 2 y el 3." },
    { q: "¿Creo yo las creatividades o las hacéis vosotros?", a: "Las hacemos nosotros. Nuestro equipo de diseño crea todas las creatividades: estáticas, carruseles, vídeos y motion graphics. Adaptadas al formato de cada plataforma y diseñadas para convertir, no solo para quedar bonitas. Tú apruebas antes de que se lancen." },
    { q: "¿Cuál es vuestra comisión?", a: "Cobramos un fee fijo mensual de gestión, no un porcentaje del presupuesto. Esto alinea nuestros incentivos con los tuyos: nos interesa que inviertas lo justo para maximizar tu retorno, no que gastes más para que nosotros ganemos más." },
    { q: "¿Puedo pausar las campañas cuando quiera?", a: "Sí. Las campañas se pueden pausar en cualquier momento. Si tienes un mes con menos presupuesto o necesitas parar por cualquier razón, simplemente nos avisas. No hay permanencias ni penalizaciones." },
  ],
