    ...
    <>
      ...
      <style>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pillars { display: grid; grid-template-columns: repeat(3, 1fr); gap: 1px; background: rgba(0,74,173,0.12); border: 1px solid rgba(0,74,173,0.12); margin-top: 3.5rem; }
        .pillar { background: #fff; padding: 2.5rem; }
        .pillar:hover { background: #f5f8ff; }
        .p-icon { width: 44px; height: 44px; border-radius: 10px; background: rgba(0,74,173,0.07); display: flex; align-items: center; justify-content: center; font-size: 1.25rem; margin-bottom: 1.5rem; }
        .p-title { font-family: var(--font-display), system-ui; font-weight: 700; font-size: 1.1rem; margin-bottom: 0.75rem; }
        .p-desc { font-size: 0.9375rem; color: #5a6480; line-height: 1.7; font-weight: 300; }
